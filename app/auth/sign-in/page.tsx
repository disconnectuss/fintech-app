          ...
          <div className="flex-1 flex items-center justify-center px-2 sm:px-0">
            <div className="w-full max-w-[520px] space-y-6 sm:space-y-8 md:space-y-10">
              <div className="space-y-2 sm:space-y-3">
                <h1 className="text-3xl sm:text-4xl md:text-[42px] leading-tight font-semibold text-(--text-primary)">Sign In</h1>
                <p className="text-sm sm:text-base text-(--text-secondary)">Welcome back! Please enter your details</p>
              </div>
              <SignInForm />
            </div>
          </div>
